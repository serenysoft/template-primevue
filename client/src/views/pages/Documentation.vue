<template>
  <div class="card">
    ...
    <p class="text-lg mb-4">
      Sakai is an application template for Vue based on the <a
      ...
      projects. To get started, clone the <a
        href="https://github.com/primefaces/sakai-vue"
        class="font-medium text-primary hover:underline"
      >repository</a> from GitHub and install the dependencies with npm or yarn.
    </p>
    <pre class="app-code">
...
npm run dev</code></pre>
    ...
    <p class="text-lg mb-4">
      Navigate to <i class="bg-highlight px-2 py-1 rounded-border not-italic text-base">http://localhost:5173/</i> to view the application in your local environment.
    </p>
